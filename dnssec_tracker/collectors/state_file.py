...
class StateFileCollector(Collector):
    ...
    async def sample(self) -> None:
        ...
        # Detect vanished keys: anything in the snapshot store but not
        # in this scan.
        # (We can't enumerate all scopes cheaply without a helper — skip
        # for now; key files move to `deleted/` subdirs rather than
        # disappearing from the filesystem in iodyn's workflow.)
